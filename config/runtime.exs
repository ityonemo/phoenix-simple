...
# and secrets from environment variables or elsewhere. Do
# not define
# any compile-time configuration in here, as it won't be applied.
# The block below contains prod specific runtime configuration.

# always spin up the endpoint server.
config :my_app, Web.Endpoint, server: config_env() != :test
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/my_app/my_app_prod.db
      """
